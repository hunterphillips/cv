...
> Solutions Architect with a track record of leading platform modernization and driving user-centric automation across federal and commercial sectors. Skilled in low-code, modern web, and AI frameworks, with a passion for scalable design and measurable business impact. Active security clearance.
...
<br/><br/>
![feather screenshot](https://raw.githubusercontent.com/hunterphillips/cv/gh-page/assets/feather.png)

---

**[Email Writer](https://github.com/hunterphillips/email-writer)**
A fine-tuning pipeline that trains OpenAI models to write emails in your personal style. Processes Gmail exports, strips noise, and generates synthetic training prompts. Includes a side-by-side comparison mode to evaluate the fine-tuned model against the base.
<br/><br/>
![email writer screenshot](https://raw.githubusercontent.com/hunterphillips/cv/gh-page/assets/email-writer.png)
...
<br/><br/>
![sn mockup screenshot](https://raw.githubusercontent.com/hunterphillips/cv/gh-page/assets/sn-mockup.png)
...
**[Countdown](https://github.com/hunterphillips/countdown)**
Desktop app that uses demographic inputs and health metrics to calculate a real-time countdown to your statistically estimated death. Built with Electron and AngularJS. 21 GitHub stars, two public releases.
<br/><br/>
![countdown screenshot](https://raw.githubusercontent.com/hunterphillips/cv/gh-page/assets/clock-screenshot.jpeg)
